...
export const acceptConnectionRequest = async (req, res) => {
    try {
        ...
        await User.findByIdAndUpdate(request.sender._id, { $addToSet: { connections: userId } }); //Push your id to my connections array
        await User.findByIdAndUpdate(userId, { $addToSet: { connections: request.sender._id } }); //Push my id to your connections array
